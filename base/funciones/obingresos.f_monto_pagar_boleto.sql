CREATE OR REPLACE FUNCTION obingresos.f_monto_pagar_boleto (
  p_id_boleto integer,
  p_monto numeric,
...
$body$
/**************************************************************************
 FUNCION: 		obingresos.f_monto_pagar_boleto
 DESCRIPCION:   devuelve el monto de la forma pago disponible para pagar el boleto
 AUTOR: 	    RCM
 FECHA:			06/09/2013
 COMENTARIOS:	
***************************************************************************
...
BEGIN
    v_nombre_funcion:='obingresos.f_monto_pagar_boleto';
