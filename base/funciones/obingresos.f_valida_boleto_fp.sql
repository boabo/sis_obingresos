CREATE OR REPLACE FUNCTION obingresos.f_valida_boleto_fp (
  p_id_boleto integer
)
RETURNS varchar AS
$body$
/**************************************************************************
 FUNCION: 		obingresos.f_valida_boleto_fp
 DESCRIPCION:   valida que las formas de pago sean iguales o mayores al monto del boleto
 AUTOR: 	    RCM
 FECHA:			06/09/2013
 COMENTARIOS:	
***************************************************************************
