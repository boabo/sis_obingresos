	...
	***********************************/
		...
		begin
           ...
           IF EXISTS (	select 1
                        ...
                        raise notice 'Exite';
           ELSE
           	--COMENTANDO PARA NO REPLICAR EN LA TABLA TMOD_FORMA_PAGO ISMAEL VALDIVIA 03/02/2021
			...
			id_medio_pago = v_parametros.id_forma_pago,
...
ALTER FUNCTION obingresos.ft_boleto_forma_pago_ime (p_administrador integer, p_id_usuario integer, p_tabla varchar, p_transaccion varchar)
  OWNER TO postgres;
