...
<script>
    Phx.vista.BuscarBoletoAmadeusExterno = Ext.extend(Phx.gridInterfaz, {
        ...
        constructor : function(config) {
            ...
            Phx.vista.BuscarBoletoAmadeusExterno.superclass.constructor.call(this, config);
            ...
            this.txtSearch.on('keyup', function (field, e) {
                ...
                if(this.txtSearch.getValue().length == 13) {
                    console.log('valores keyup:', this.id_punto_venta,this.moneda_base, this.fecha );
                    Ext.Ajax.request({
        ...
        successGetVariables : function (response,request) {
            ...
            this.field_date = new Date(fecha_array[2],parseInt(fecha_array[1]) - 1,fecha_array[0]);

            Ext.Ajax.request({
                url:'../../sis_ventas_facturacion/control/AperturaCierreCaja/getTipoCambio',
                params:{
                    fecha_cambio : this.field_date.dateFormat('d/m/Y')
                },
                success: function(resp){
                    var reg =  Ext.decode(Ext.util.Format.trim(resp.responseText));
            ...
            storeCombo.load({params:{start: 0, limit: this.tam_pag},
                callback : function (r) {
                    ...
                    if (this.variables_globales.vef_tiene_punto_venta === 'false' ) {
                        ...
                        var fecha_boleto = new Ext.form.DateField({
                            name: 'fecha_boleto',
                            fieldLabel: 'Fecha',
                            allowBlank: false,
                            anchor: '77%',
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        if(fecha_boleto.getValue()){
                                            this.fecha = fecha_boleto.getValue().dateFormat('Ymd');
                                        }else {
                                            this.fecha = this.field_date.dateFormat('Ymd');
                                        }
                                        Ext.Ajax.request({
                                            url    : '../../sis_obingresos/control/Boleto/traerBoletosJson',
                                            params : {
                                        ...
                                        if (formularioInicio.getForm().isValid()) {
                                            ...
                                            this.store.baseParams.fecha = this.field_date.dateFormat('d/m/Y');
        ...
        preparaMenu:function(tb){
            Phx.vista.BuscarBoletoAmadeusExterno.superclass.preparaMenu.call(this,tb);
        ...
        liberaMenu:function(tb){
            Phx.vista.BuscarBoletoAmadeusExterno.superclass.liberaMenu.call(this,tb);
            this.getBoton('btnImprimir').disable();
            this.getBoton('btnImprimir').setVisible(true);
        ...
        onBtnBuscar : function() {
            //console.log('valores onBtnBuscar:', this.id_punto_venta,this.moneda_base, this.fecha );
            /*Ext.Ajax.request({
                url    : '../../sis_obingresos/control/Boleto/traerBoletosJson',
                params : {
                    id_punto_venta  :   this.id_punto_venta,
