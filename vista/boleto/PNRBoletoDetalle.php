...
?>
<script>
    Phx.vista.PNRBoletoDetalle=Ext.extend(Phx.gridInterfaz,{

            constructor:function(config){
                this.maestro=config.maestro;
                Phx.vista.PNRBoletoDetalle.superclass.constructor.call(this, config);
                this.init();
            ...
            arrayDefaultColumHidden:['estado_reg','usuario_ai',
                'fecha_reg','fecha_mod','usr_reg','usr_mod','estado','codigo_noiata','codigo_agencia','neto','tipopax','nombre_agencia','comision'],
            ...
            onButtonEdit : function () {
                Phx.vista.PNRBoletoDetalle.superclass.onButtonEdit.call(this);
            ...
            onButtonNew : function () {
                Phx.vista.PNRBoletoDetalle.superclass.onButtonNew.call(this);
                this.Cmp.ids_seleccionados.reset();
                this.grupo = 'no';
            ...
            successSave:function(resp){
                ...
                Phx.vista.PNRBoletoDetalle.superclass.successSave.call(this, resp);
            ...
            {	var rec = this.sm.getSelected();
                ...
                Phx.vista.PNRBoletoDetalle.superclass.preparaMenu.call(this);
            ...
            liberaMenu:function()
            {
                ...
                Phx.vista.PNRBoletoDetalle.superclass.liberaMenu.call(this);
            ...
            onReloadPage : function(m) {
                this.maestro = m;
                this.store.baseParams={localizador:this.maestro.localizador, fecha_emision: this.maestro.fecha_emision.dateFormat('d/m/Y'), mycls:this.cls, estado:'borrador'};
