...
Phx.vista.ConsultMcoS=Ext.extend(Phx.gridInterfaz,{
    ...
    this.init();
    console.log('this',this.grid.body);
...

        {
            config:{
                ...
                renderer: function (value, p, record) {
                  ...
                  var fecha_tkt = format_fecha(record.data['fecha_doc_or']);
                  var fecha_reg = format_fecha(record.data['fecha_reg']);
                    ...
                    <table  class="t-interno-mco" cellpadding="5" cellspacing="5">
                        <tr>
                          ...
                          <td width="188px"><b>Fecha Emision: </b><span>${fecha_emis.fecha}</span></td>
                    ...
                    <table  cellpadding="5" cellspacing="5">
                      ...
                      <tr  class="tkt_footer">
                        ...
                        <td width="100px">${fecha_tkt.fecha}</td>
                        <td width="100px">${record.data['t_c_doc_or']}</td>
                        <td width="100px">${record.data['moneda_doc_or']}</td>
                        <td width="150px">${record.data['val_total_doc_or']}</td>
