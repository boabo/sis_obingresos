...
/**
 * @package pXP
 * @file    RepCorrelativoFacturasTfactura.php
...
?>
<script>
    Phx.vista.RepCorrelativoFacturasTfactura = Ext.extend(Phx.frmInterfaz, {
        Atributos: [
            {
                config: {
                    name: 'nivel',
        ...
        ActSave: '../../sis_obingresos/control/ReporteCorrelativoFacturasFac/repCorrelativoFacturasTfactura',
        topBar: true,
        botones: false,
        labelSubmit: 'Imprimir',
        tooltipSubmit: '<b>Generar Reporte</b>',
        constructor: function (config) {
            Phx.vista.RepCorrelativoFacturasTfactura.superclass.constructor.call(this, config);
            this.init();
            this.iniciarEventos();
